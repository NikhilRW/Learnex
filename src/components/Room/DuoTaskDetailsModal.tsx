    ...
    const toggleSubtaskCompletion = async (subtaskId: string, completed: boolean) => {
        ...
        try {
            await taskService.updateDuoTaskSubtask(task.id, subtaskId, {
                completed: !completed,
                completedBy: !completed ? auth().currentUser?.uid : undefined,
                completedAt: !completed ? firestore.Timestamp.now() : undefined
            });
                    ...
                    <View style={{ marginHorizontal: 16, marginBottom: 10 }}>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 5 }}>
                            ...
                            <View style={{
                                ...
                                paddingVertical: 2,
                                borderRadius: 10,
                                backgroundColor: task?.completed ? '#34C759' : task?.collaborationStatus === 'active' ? '#007AFF' : '#FF9500',
                            }}>
                    ...
                    <ScrollView style={styles.modalBody}>
                        ...
                        {activeTab === 'details' && (
                            <View className='pb-10'>
                                <View style={modalDetailStyles.detailItem}>
                                    <Text style={[modalDetailStyles.detailLabel, { color: isDark ? '#8e8e8e' : '#666' }]}>
                                        Description
                                    </Text>
                                    <Text style={[modalDetailStyles.detailValue, { color: isDark ? 'white' : 'black' }]}>
                                ...
                                <View style={modalDetailStyles.detailItem}>
                                    <Text style={[modalDetailStyles.detailLabel, { color: isDark ? '#8e8e8e' : '#666', marginBottom: 5 }]}>
                                        Team Members
                                    </Text>
                        ...
                        {activeTab === 'subtasks' && (
                            <View>
                                ...
                                <Text style={[modalDetailStyles.detailLabel, { color: isDark ? '#8e8e8e' : '#666', marginBottom: 10 }]}>
                                        ...
                                        <View key={subtask.id} style={{
                                            ...
                                            <TouchableOpacity
                                                style={{
                                                    ...
                                                    justifyContent: 'center',
                                                    alignItems: 'center',
                                                    backgroundColor: subtask.completed ? '#1a9cd8' : 'transparent',
                                                    marginRight: 10
                                                }}
                                                onPress={() => toggleSubtaskCompletion(subtask.id, subtask.completed)}
                                            >
                                                {subtask.completed && (
                                            ...
                                            <View style={{ flex: 1 }}>
                                                ...
                                                {subtask.assignedTo && (
                                                    <Text style={{
                                                        ...
                                                        Assigned to: {subtask.assignedTo === auth().currentUser?.uid ? 'You' : 'Team Member'}
                                                    </Text>
                                                )}
                                                ...
                                                {subtask.completedBy && (
                                                    <Text style={{
                                                        ...
                                                        Completed by: {subtask.completedBy === auth().currentUser?.uid ? 'You' : 'Team Member'}
                                                    </Text>
                                                )}
                                            </View>
                                        </View>

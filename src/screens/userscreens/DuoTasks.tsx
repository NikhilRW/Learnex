        ...
        switch (selectedFilter) {
            case 'active':
                result = result.filter(task =>
                    task.collaborationStatus === 'active' && !task.completed
                );
                break;
            case 'pending':
                result = result.filter(task =>
                    task.collaborationStatus === 'pending'
                );
                break;
            case 'completed':
                result = result.filter(task =>
            ...
            <View style={styles.taskContent}>
                ...
                <View style={styles.taskFooter}>
                    <View style={styles.taskMeta}>
                        <Icon name="person-outline" size={14} color={isDark ? '#8e8e8e' : '#666'} />
                        <Text style={[styles.taskMetaText, { color: isDark ? '#8e8e8e' : '#666', marginLeft: 5 }]}>
                            From: {item.userId === auth().currentUser?.uid ? 'You' : 'Team Member'}
                        </Text>
                    </View>
        ...
        >
            <View style={styles.taskContent}>
                ...
                <View style={styles.taskFooter}>
                    ...
                    <View style={styles.taskMeta}>
                        <Icon name="people-outline" size={14} color={isDark ? '#8e8e8e' : '#666'} />
                        <Text style={[styles.taskMetaText, { color: isDark ? '#8e8e8e' : '#666', marginLeft: 5 }]}>
            ...
            <View style={styles.contentContainer}>
                ...
                {isLoading ? (
                    <View style={styles.loadingContainer}>
                        ...
                        <Text style={[styles.loadingText, { color: isDark ? '#fff' : '#000' }]}>Loading team tasks...</Text>
                    </View>

...
const TeamTaskModal: React.FC<TeamTaskModalProps> = ({
  ...
  const fetchCollaboratorDetails = async () => {
    ...
    for (const id of otherCollaboratorIds) {
      try {
        ...
        logger.error(
          'Error fetching collaborator details:',
          err,
          'TeamTaskModal',
        );
      }
  ...
  const searchCollaborator = async () => {
    ...
    try {
      ...
      logger.error('Error searching for collaborator:', err, 'TeamTaskModal');
        ...
        <View
          ...
          <View
            ...
            <TouchableOpacity
              ...
              <Text style={isDark ? styles.darkTabText : styles.tabText}>
                Task Details
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
                ...
                <View style={styles.inputGroup}>
                  <View style={styles.notifyContainer}>
                    ...
                    <Switch
                      ...
                      thumbColor={
                        task.notify ? '#fff' : isDark ? '#888' : '#f4f3f4'
                      }
                      ...
                      renderItem={({item}) => (
                        <View
                          style={[
                            ...
                            isDark
                              ? styles.teamSubtaskListItemDark
                              : styles.teamSubtaskListItemLight,
                          ]}>
                          <TouchableOpacity
                            style={[
                ...
                <View style={styles.inputGroup}>
                  ...
                  {collaborators.length === 0 ? (
                    <Text
                      ...
                      No team members added yet. Add collaborators to work
                      together!
                    </Text>
                  ) : (
                    <LegendList
                  ...
                  <Text
                    ...
                    Once you save the task, your team members will receive
                    invitations.
                  </Text>
                </View>
              </>

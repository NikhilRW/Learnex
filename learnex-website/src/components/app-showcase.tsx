    ...
    const screenshots = [
        {
            image: "/post.png",
            title: "Social Feed",
            description: "Connect with peers and share knowledge through our distraction-minimized social feed",
            gradient: "from-blue-600/30 to-blue-400/10"
        },
        {
            image: "/app.png",
            title: "User Profile",
            description: "Customize your profile and control your privacy settings for different content types",
            gradient: "from-purple-600/30 to-purple-400/10"
        },
        {
            image: "/message.png",
            title: "Group Chats",
            description: "Collaborate in topic-specific groups with real-time messaging and file sharing",
            gradient: "from-green-600/30 to-teal-400/10"
        },
        {
            image: "/room.png",
            title: "Virtual Meetings",
            description: "Host or join video calls with screen sharing for interactive study sessions",
            gradient: "from-amber-600/30 to-amber-400/10"
        },
        {
            image: "/event.png",
            title: "Event Discovery",
            description: "Explore events, hackathons and competitions in your region and participate directly",
            gradient: "from-red-600/30 to-rose-400/10"
        },
    ];

    return (
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-background relative overflow-hidden" id="screenshots">
            {/* Background elements */}
            ...
            <div className="max-w-screen-xl mx-auto relative z-10">
                ...
                <div className="text-center mb-10">
                    ...
                    >
                        See how Learnex helps students connect, collaborate, and learn together
                    </motion.p>
                </div>
                            ...
                            {screenshots.map((screenshot, index) => (
                                <SwiperSlide key={index}>
                                    ...
                                    <div className="text-center mt-4 max-w-xs mx-auto">
                                        ...
                                        <p className="text-foreground/70 text-sm px-4">{screenshot.description}</p>
                                    </div>
                                </SwiperSlide>
                            ))}
                        </Swiper>
                    ...
                    {[
                        {
                            ...
                            description: "Clean, modern interface that's easy to navigate and reduces cognitive load.",
                            icon: (
                        ...
                        },
                        {
                            ...
                            description: "Granular privacy settings giving you control over what you share.",
                            icon: (
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        },
                        {
                            ...
                            description: "Easily share study materials to enhance collaborative learning.",
                            icon: (
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
